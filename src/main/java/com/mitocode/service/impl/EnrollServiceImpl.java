...
public class EnrollServiceImpl extends CRUDImpl<Enroll, Integer> implements IEnrollService{
	...
	public Map<String, Set<String>> getStudentGroupByCourse() {
		...
		//List<List<EnrollDetail>> list = streamListEnrollDetail.collect(Collectors.toList());
...
//		
		...
		//System.out.println(list);
		 //[EnrollDetail(idEnrollDetail=2, classRoom=A, course=Course(idCourse=4, nameCourse=sping boot, acronymCourse=SPB, enabledCourse=true)), EnrollDetail(idEnrollDetail=3, classRoom=A, course=Course(idCourse=4, nameCourse=sping boot, acronymCourse=SPB, enabledCourse=true)), EnrollDetail(idEnrollDetail=4, classRoom=B, course=Course(idCourse=6, nameCourse=java AWS, acronymCourse=JAWS, enabledCourse=true)), EnrollDetail(idEnrollDetail=5, classRoom=C, course=Course(idCourse=8, nameCourse=ARQ HEXAGONAL, acronymCourse=ARQHEX, enabledCourse=true)), EnrollDetail(idEnrollDetail=6, classRoom=A, course=Course(idCourse=4, nameCourse=sping boot, acronymCourse=SPB, enabledCourse=true)), EnrollDetail(idEnrollDetail=7, classRoom=B, course=Course(idCourse=6, nameCourse=java AWS, acronymCourse=JAWS, enabledCourse=true)), EnrollDetail(idEnrollDetail=9, classRoom=D, course=Course(idCourse=7, nameCourse=FULL STACK, acronymCourse=FS, enabledCourse=true)), EnrollDetail(idEnrollDetail=8, classRoom=C, course=Course(idCourse=8, nameCourse=ARQ HEXAGONAL, acronymCourse=ARQHEX, enabledCourse=true)), EnrollDetail(idEnrollDetail=10, classRoom=A, course=Course(idCourse=4, nameCourse=sping boot, acronymCourse=SPB, enabledCourse=true)), EnrollDetail(idEnrollDetail=14, classRoom=H, course=Course(idCourse=5, nameCourse=java testing, acronymCourse=JAVAT, enabledCourse=true)), EnrollDetail(idEnrollDetail=11, classRoom=B, course=Course(idCourse=6, nameCourse=java AWS, acronymCourse=JAWS, enabledCourse=true)), EnrollDetail(idEnrollDetail=13, classRoom=D, course=Course(idCourse=7, nameCourse=FULL STACK, acronymCourse=FS, enabledCourse=true)), EnrollDetail(idEnrollDetail=12, classRoom=C, course=Course(idCourse=8, nameCourse=ARQ HEXAGONAL, acronymCourse=ARQHEX, enabledCourse=true)), EnrollDetail(idEnrollDetail=20, classRoom=C, course=Course(idCourse=8, nameCourse=ARQ HEXAGONAL, acronymCourse=ARQHEX, enabledCourse=true))]
